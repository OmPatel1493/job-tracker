"""create users, job_applications, notes tables

Revision ID: 64b0f0940473
Revises: 
Create Date: 2026-03-12 17:41:41.059997
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('APPLIED', 'PHONE_SCREEN', 'INTERVIEW', 'OFFER', 'REJECTED', 'WITHDRAWN', name='applicationstatus'), nullable=False),
